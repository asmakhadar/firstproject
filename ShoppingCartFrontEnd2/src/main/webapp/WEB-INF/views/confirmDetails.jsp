  ...
  <div class="row-fluid">
		<fieldset>
			...
			<sf:form modelAttribute="user">
				<sf:label path="first_name">First name :</sf:label>    ${user.first_name}
					<br />
				<br />
				<sf:label path="last_name"> Last name:</sf:label> ${user.last_name}
					<br />
				<br />
				<sf:label path="password">Password :</sf:label> ${user.password}
				<br>
					<br>
                <sf:label path="email_id">Email id:</sf:label> ${user.email_id}
					<br />
				<br />
				<sf:label path="mobile_number">Mobile number:</sf:label> ${user.mobile_number}
					<br />
				<br />
