...
<nav class="navbar navbar-inverse"  >
  ...
  <!--  <a style="color:#ff8080" class="navbar-brand" href="home"><span style="color:Khaki"class="glyphicon glyphicon-flash"></span>WATCHES</a>   -->
    <a class="navbar-brand" href="home"><font style="font-family: italian; font-size: 35px; color: #ff8080;"><strong>Watches</strong></font>
				</a> 
    ...
    <ul class="nav navbar-nav navbar-right">   
      ...
      <c:if test="${pageContext.request.userPrincipal.name  == 'asma786@gmail.com'}">
       ...
       <li><a style="color:Khaki" href="contactus"><span class="glyphicon glyphicon-phone-alt"></span>CONTACTUS</a></li>
        <li><a href="profile" style="color:Khaki">Hello, ${pageContext.request.userPrincipal.name}</a></li>
                    <li><a  style="color:Khaki;margin:0px 0px 0px 0px" href="<c:url value="/myCart"/>"><span class="glyphicon glyphicon-shopping-cart"></span> Cart (${cartSize})</a></li>
