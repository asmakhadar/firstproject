...
<body>
	...
	<c:if test="${!empty cartList}">
					...
					<div class="row">
							<div class="col-xs-12">
								<h5 style="color:darkgreen bold"><span style="color:black" class="glyphicon glyphicon-shopping-cart"></span> SHOPPING CART </h5>
			...
			<div class="panel panel-info" >
				<div class="panel-heading">
					...
					<div class="row">	
						<div style="color:black" class="col-xs-3">ITEM</div>
						<div style="color:black" class="col-xs-3">DESCRIPTION</div>
						<div style="color:black" class="col-xs-2">QUANTITY</div>
						<div style="color:black" class="col-xs-2">PRICE	</div>
						<div  style="color:black"class="col-xs-2">REMOVE</div>
						</div>
					</div>
				</div>
