	...
	<c:if test="${!empty cartList}">
					...
					<div class="row">
							...
							<table class="table table-stripped">
								<h5 style="color:darkgreen bold"><span style="color:black" class="glyphicon glyphicon-shopping-cart"></span>REVIEW ORDER</h5>
			...
			<div class="panel panel-info" >
				<div class="panel-heading">
					...
					<div class="row">	
								...
								<div style="color:black" class="col-xs-4">DESCRIPTION</div>
								<div style="color:black" class="col-xs-3">QUANTITY</div>
